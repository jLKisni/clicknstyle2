              ...
              <div class="col-md-5">
                 <img src="<?php echo base_url();?>assets/servicesimage/<?php echo $service->service_photo;?>" alt="" width="300" height="200"/>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                          <a href="<?php echo base_url();?>Web/salon/<?php echo $service->SalonID;?>"><img src="<?php echo base_url();?>assets/usersimage/<?php echo $service->user_image;?>" alt="" width="100" height="100"/></a>
                    </div>
                    <div class="col-md-8">
