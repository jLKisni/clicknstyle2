...
<div class="main-navigation">
  ...
  <ul class="menu">
    ...
    <li class="menu-item current-menu-item"><a href="<?php echo base_url();?>GlobalService/salons">Salons</a></li>
    ...
    <div class="container">
      ...
      <div class="filterable-items">
        ...
        <div class="gallery-item filterable-item">
          <a href="<?php echo base_url();?>GlobalService/salon/<?php echo $row->SalonID;?>">
